...
-- AddForeignKey
ALTER TABLE `User` ADD CONSTRAINT `User_followedByUserId_fkey` FOREIGN KEY (`followedByUserId`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `User` ADD CONSTRAINT `User_followingUserId_fkey` FOREIGN KEY (`followingUserId`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
